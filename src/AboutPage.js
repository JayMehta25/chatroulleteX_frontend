...
const jayPhoto = 'https://avatars.githubusercontent.com/u/9919?s=280&v=4'; // Example: GitHub logo, replace with your desired image URL
...
export default function AboutPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'black', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem', position: 'relative' }}>
      ...
      <div className={exitAnim ? 'about-exit-anim' : ''} style={{ width: '100%' }}>
        <h1 style={{
          color: '#00d8ff',
          marginBottom: '2.5rem',
          textAlign: 'center',
